...
class ConversationScreen extends StatelessWidget {
  ...
  Future<Conversation?> showConversationDialog(BuildContext context,
      bool isEdit, Conversation conversation) =>
  ...
  Widget build(BuildContext context) {
    ...
    String version = "";
    // PackageInfo.fromPlatform().then((value) => version = value.buildNumber);
